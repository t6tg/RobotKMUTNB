...
<center>
<h1>Game 1</h1>
<input type="radio"  name="g1_st" value="1" <?=($row_admin['g1_st']=='1')?"checked":""?>>on</input>
<input type="radio"  name="g1_st" value="0"<?=($row_admin['g1_st']=='0')?"checked":""?>>off</input>
<h1>Game 2</h1>
<input type="radio"  name="g2_st" value="1" <?=($row_admin['g2_st']=='1')?"checked":""?>>on</input>
<input type="radio"  name="g2_st" value="0"<?=($row_admin['g2_st']=='0')?"checked":""?>>off</input>
<h1>Game 3</h1>
<input type="radio"  name="g3_st" value="1" <?=($row_admin['g3_st']=='1')?"checked":""?>>on</input>
<input type="radio"  name="g3_st" value="0" <?=($row_admin['g3_st']=='0')?"checked":""?>>off</input>
<h1>Game สำรอง  </h1>
<input type="radio"  name="g4_st" value="1" <?=($row_admin['g4_st']=='1')?"checked":""?>>on</input>
<input type="radio"  name="g4_st"value="0" <?=($row_admin['g4_st']=='0')?"checked":""?>>off</input>
<br>
<br>
