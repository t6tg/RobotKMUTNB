...
<center><form action="upload2.php" style="margin-bottom: 200px;" class="frm" method="post" enctype="multipart/form-data">
    Select File to upload Game 2    :
    <input type="file"  accept=".txt" name="game2" id="game2" required><br><br>
