...
<center><form action="upload3.php" style="margin-bottom: 200px;" class="frm" method="post" enctype="multipart/form-data">
    Select File to upload Game 3    :
    <input type="file"  accept=".txt" name="game3" id="game3" required><br><br>
