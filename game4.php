...
<center><form action="upload4.php" style="margin-bottom: 200px;" class="frm" method="post" enctype="multipart/form-data">
    Select File to upload Game สำรอง    :
    <input type="file"  accept=".txt" name="game4" id="game4" required><br><br>
